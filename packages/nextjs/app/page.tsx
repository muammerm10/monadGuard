      ...
      <div className="flex items-center flex-col grow pt-16 pb-20 px-4">
        <div className="max-w-4xl w-full mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-base-content/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            MonadGuard is a community-driven malware threat registry powered by the Monad blockchain. Stake MON, report
            zero-day threats, and earn rewards for securing the ecosystem.
          </p>
